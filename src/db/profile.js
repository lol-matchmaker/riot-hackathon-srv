...
function updateStatistics(update_info, name) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exports.ProfileModel.findOne({
                        where: {
                            summoner_name: name
                        },
                        raw: true
                        ...
                        exports.ProfileModel.update(Object.assign(res, { stats: update_info }), { where: {
                                summoner_name: name
                            }
                        });
                    })];
...
function updateCompatibility(summonerName, summonerName_toChange, add) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exports.ProfileModel.findOne({
...
exports.updateCompatibility = updateCompatibility;
